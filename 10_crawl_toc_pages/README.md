...
```bash
# Test spider only
uv run pytest 10_crawl_toc_pages/tests/test_spider.py -v

# Test pipelines only
uv run pytest 10_crawl_toc_pages/tests/test_pipelines.py -v
```

### Coverage Report
```bash
uv run pytest 10_crawl_toc_pages/tests/ --cov=solidworks_scraper --cov-report=html
```
