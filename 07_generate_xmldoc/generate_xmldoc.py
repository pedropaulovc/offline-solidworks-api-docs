...
Examples:
  ...
  uv run python 07_generate_xmldoc/generate_xmldoc.py --output-dir custom/path
    ...
    parser.add_argument(
        ...
        help='Path to api_members.xml from Phase 02'
    )
    ...
    parser.add_argument(
        ...
        help='Path to api_types.xml from Phase 03'
    )
    ...
    parser.add_argument(
        ...
        help='Path to enum_members.xml from Phase 04'
    )

    parser.add_argument(
        '--examples-file',
        type=Path,
        default=Path('06_parse_examples/output/examples.xml'),
        help='Path to examples.xml from Phase 06'
    )

    parser.add_argument(
        '--output-dir',
        type=Path,
        default=Path('07_generate_xmldoc/output'),
    ...
    parser.add_argument(
        '--metadata-dir',
        type=Path,
        default=Path('07_generate_xmldoc/metadata'),
