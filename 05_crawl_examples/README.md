# Phase 5: Crawl Example Pages

This directory contains the Scrapy-based crawler for downloading SolidWorks API example pages referenced in the `api_types.xml` file from Phase 3. The crawler extracts clean HTML content from the `__NEXT_DATA__` JSON embedded in each page.
...
- [Phase 1 README](../01_crawl_toc_pages/README.md) - TOC crawler
