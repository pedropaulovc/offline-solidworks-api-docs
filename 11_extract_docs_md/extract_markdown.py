...
class MarkdownExtractor:
    ...
    def __init__(
        self,
        input_dir: Path = Path("10_crawl_programming_guide/output/html"),
        metadata_file: Path = Path("10_crawl_programming_guide/metadata/urls_crawled.jsonl"),
