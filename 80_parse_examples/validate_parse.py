...
def main(verbose: bool = False) -> int:
    ...
    # Define paths
    xml_file = project_root / '80_parse_examples' / 'output' / 'examples.xml'
    metadata_dir = project_root / '80_parse_examples' / 'metadata'
    source_dir = project_root / '70_crawl_examples' / 'output' / 'html'
