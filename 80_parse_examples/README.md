...
- **Phase 7** must be completed (HTML files in `70_crawl_examples/output/html/`)
- Python 3.12+
...
This will:
1. Read all HTML files from `70_crawl_examples/output/html/`
...
```bash
uv run python 80_parse_examples/validate_parse.py --verbose
```
...
```json
{
  ...
  "input_directory": "70_crawl_examples/output/html",
  "output_file": "80_parse_examples/output/examples.xml",
  "total_examples": 1198
}
```
...
- HTML files: `70_crawl_examples/output/html/**/*.htm`
