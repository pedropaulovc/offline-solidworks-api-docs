...
This script:
1. Reads HTML files from 07_crawl_examples/output/html/
...
def main():
    ...
    # Define paths
    html_dir = project_root / '07_crawl_examples' / 'output' / 'html'
    output_file = project_root / '08_parse_examples' / 'output' / 'examples.xml'
