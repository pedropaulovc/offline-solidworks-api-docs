...
```bash
# From project root
uv run python 100_crawl_programming_guide/run_crawler.py --test

# Or from this directory
cd 100_crawl_programming_guide
...
```bash
uv run python 100_crawl_programming_guide/run_crawler.py --resume
```
...
uv run python 100_crawl_programming_guide/validate_crawl.py --verbose
```
...
# Specific test file
uv run pytest 100_crawl_programming_guide/tests/test_spider.py -v
```
