        ...
        try:
            with jsonlines.open(urls_file) as reader:
                for obj in reader:
                    ...
                    # Check URL is within boundary (allow expandToc API calls and regular pages)
                    if url and "/2026/english/api/" not in url and "/expandToc" not in url:
            ...
            # Check for minimum page count (allow 5% regression from expected 145 for Programming Guide)
