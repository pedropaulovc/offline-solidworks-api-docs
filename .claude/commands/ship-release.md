...
1. Confirm the generated filenames include the exact release version.
2. Do not copy or rename unversioned files. Phase 200 now writes the final GitHub asset names directly.
