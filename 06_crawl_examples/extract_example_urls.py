...
Usage:
    python 05_crawl_examples/extract_example_urls.py
    python 05_crawl_examples/extract_example_urls.py --output urls.txt
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--input",
        type=Path,
        default=Path("03_extract_type_info/metadata/api_types.xml"),
        help="Path to api_types.xml file (default: 03_extract_type_info/metadata/api_types.xml)",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("05_crawl_examples/metadata/example_urls.txt"),
        help="Output file for extracted URLs (default: 05_crawl_examples/metadata/example_urls.txt)",
    )
    parser.add_argument(
        "--verbose",
        "-v",
