...
from phase 40_extract_type_details.

Usage:
    python 70_crawl_examples/run_crawler.py [options]
...
def ensure_xml_file(project_dir: Path) -> bool:
    ...
    xml_file = project_dir.parent / "40_extract_type_details" / "metadata" / "api_types.xml"
