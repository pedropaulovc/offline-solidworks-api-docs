...
merger.load_api_members('20_extract_types/metadata/api_members.xml')
merger.load_api_types('40_extract_type_details/metadata/api_types.xml')
merger.load_enum_members('60_extract_enum_members/metadata/enum_members.xml')
merger.load_examples('80_parse_examples/output/examples.xml')
...
```bash
ls 20_extract_types/metadata/api_members.xml
ls 40_extract_type_details/metadata/api_types.xml
ls 60_extract_enum_members/metadata/enum_members.xml
ls 80_parse_examples/output/examples.xml  # Optional
```
