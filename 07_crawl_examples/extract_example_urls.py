...
Usage:
    python 07_crawl_examples/extract_example_urls.py
    python 07_crawl_examples/extract_example_urls.py --output urls.txt
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Path to api_types.xml file (default: 04_extract_type_details/metadata/api_types.xml)",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("07_crawl_examples/metadata/example_urls.txt"),
        help="Output file for extracted URLs (default: 07_crawl_examples/metadata/example_urls.txt)",
    )
    parser.add_argument(
        "--verbose",
        "-v",
