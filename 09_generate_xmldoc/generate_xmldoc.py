...
Examples:
  ...
  uv run python 09_generate_xmldoc/generate_xmldoc.py --output-dir custom/path
    ...
    parser.add_argument(
        '--enums-file',
        type=Path,
        default=Path('06_extract_enum_members/metadata/enum_members.xml'),
    ...
    parser.add_argument(
        '--examples-file',
        type=Path,
        default=Path('08_parse_examples/output/examples.xml'),
    ...
    parser.add_argument(
        '--output-dir',
        type=Path,
        default=Path('09_generate_xmldoc/output'),
    ...
    parser.add_argument(
        '--metadata-dir',
        type=Path,
        default=Path('09_generate_xmldoc/metadata'),
