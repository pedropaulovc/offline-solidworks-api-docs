...
**Input**: HTML files from Phase 3 (03_crawl_type_members/output/html)
...
uv run python 05_extract_type_member_details/extract_member_details.py --verbose
...
uv run python 05_extract_type_member_details/validate_extraction.py --verbose
```
...
# Run with coverage
uv run pytest 05_extract_type_member_details/tests/ --cov=05_extract_type_member_details
```
...
```
05_extract_type_member_details/
